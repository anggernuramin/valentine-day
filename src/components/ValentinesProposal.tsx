      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          <motion.h2
            ...
            exit={{ opacity: 0 }}
          >
            Congratulations, Vindi! You have completed the game.
          </motion.h2>
        )}
        {step === 1 && (
          <motion.h2
            ...
            exit={{ opacity: 0 }}
          >
            I have a special surprise just for you, Vindi!
          </motion.h2>
        )}
        {step === 2 && (
          <motion.div
        ...
        {step === 3 && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            Thank you for accepting, Vindi! I love you so much! 💕
            <p className="text-sm mt-4">
              You mean the world to me. Forever and always. 💌
            </p>
            <Image
